...
%->> Document settings
%---------------------------------------------------------------------------%
%\usepackage[super,list,bibtex,math,color]{Style/artratex}% document settings
...
\input{Tex/Chap_GWBasis}
\input{Tex/Chap_MergerRate}
\input{Tex/Chap_SGWB}
\input{Tex/Chap_Distinguish}
\input{Tex/Chap_PTAfPBH}
